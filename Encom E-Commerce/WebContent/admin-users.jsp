...
<%
	...
	users = (ArrayList<UserDTO>) request.getAttribute("userList");
       ...
       <% 
        ...
        <form action="./users" method="POST" id="userForm" role="form" >              
              ...
              <tbody>
               <%  if(users!=null){ 
                ...
                <tr>
                  ...
                  <td><%=u.getUser()%></td>
                  <td><%=u.getEmail() %></td>
                  <%String adminUser = (u.isAdmin())? "Administrador" : "Default"; %>
                  <td><%=adminUser %></td>

                  <td class="text-center">
                  <a href="./users?id=<%=u.getId()%>" class="text-primary">
		          	<span class="fa fa-eye"></span>Ver
		          </a>
		          <%if(!(u.getUser()).equals(sesion.getAttribute("userName"))){ int id=u.getId();%>
				...
				%>
				<tr>No hay usuarios cargados.</tr>
				<% } %>
              </tbody>
            </table>
          </div>
          ...
          <div class="row">
          	...
          	<div class="col-md-1">
          	<a href="create-user.jsp" class="btn btn-success"><span class="fa fa-plus"></span> Agregar</a>
          	</div>
          </div>
        </div>
