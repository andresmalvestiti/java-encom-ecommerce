...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav"> <a class="navbar-brand" href="./admin-home.jsp">Admin
		Panel</a>
		...
		<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
			<li class="nav-item" data-toggle="tooltip" data-placement="right"
				title="Link"><a class="nav-link" href="./products"> <i
					...
					class="nav-link-text">Productos</span>
			</a></li>
			<li class="nav-item" data-toggle="tooltip" data-placement="right"
				title="Link"><a class="nav-link" href="./users"> <i
					class="fa fa-user" aria-hidden="true"></i> <span
					class="nav-link-text">Usuarios</span>
			</a></li>
		</ul>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<form role="form" method="POST" action="./users" id="userForm" name="userForm">
								...
								<div class="form-group">
									<label>User</label> <input type="text" value="" name="user" class="form-control" required>
								</div>
								<div class="form-group">
									<label>Password</label> <input type="password" value="" name="password" class="form-control" required>
								</div>
								<div class="form-group">
									<label>Tipo Usuario</label>
									
									<div class="radio">
										<label><input type="radio" name="admin" value="0" checked="true">Default</label>
									</div>
									<div class="radio">
								...
								<div class="form-group">
									<label>Apellido</label> <input type="text"
										value="" name="surname" class="form-control" required>
								</div>
								<div class="form-group">
									<label>DNI</label> <input type="text"
										value="" name="dni" class="form-control" required>
								</div>
								<div class="form-group row">
									<label for="example-date-input" class="col-2 col-form-label">Fecha de nacimiento</label>
									<div class="col-10">
										<input class="form-control" type="date" value="" name="birthdate" id="birthdate" required>
									</div>
								</div>
								<div class="form-group">
	...
	<scriptl src="vendor/jquery/jquery.min.js"> </script> <script
		src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script> <!-- Core plugin JavaScript-->
