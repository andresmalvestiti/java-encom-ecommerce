					...
					<div class="card">
						...
						<div class="card-body">
							...
							<form role="form" method="POST" action="./products"encType="multipart/form-data">
								...
								<div class="form-group">
									<label>Nombre</label> <input type="text" name="name" class="form-control" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Precio</label> <input name="price" class="form-control" type="number" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Imagen</label> <input type="file" accept="image/jpg" name="imageName" value="select image..." >
								</div>
